...
//the Virtual Turbo feature is added to the existing 3-speed transmission with overdrive
#define VIRTUAL_TURBO true

// In some cases we want a different reverse acceleration for automatic transmission vehicles.
uint16_t automaticReverseAccelerationPercentage = 50;
