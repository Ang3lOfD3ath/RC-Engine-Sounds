...
#define MODE2_WINCH2 // Mode 2 is used for winch mode, if defined. The winch is controlled by the CH4 pot and connected to Servo CH3. BUS mode only!
#define NO_WINCH_DELAY // Use this, if you don't want a winch on / off ramp
//#define NO_WINCH_DELAY2 // Use this, if you don't want a winch on / off ramp
...
const uint16_t CH3L = 1000, CH3C = 1500, CH3R = 2000; // CH3 winch pull, off, release
const uint16_t CH4L = 1000, CH4C = 1500, CH4R = 2000; // CH4 winch pull, off, release
