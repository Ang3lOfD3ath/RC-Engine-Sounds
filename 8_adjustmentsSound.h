...
const uint8_t masterVolumePercentage[] = {100, 125, 44, 0}; // loud, medium, silent, no sound (more than 100% may cause distortions)

// Crawler mode
const uint8_t masterVolumeCrawlerThreshold = 125; // If master volume is <= this threshold, crawler mode (without virtual inertia) is active
